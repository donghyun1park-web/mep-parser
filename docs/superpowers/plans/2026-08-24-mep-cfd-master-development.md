...
전체 로컬 Python 3.14 회귀는 `1293 passed, 14 skipped, 7 warnings, 123 subtests passed`였고 실패 2건은 인증 Python 3.12.10 실행 파일 SHA 고정 검사와 현재 Python 3.14 런타임의 불일치다. locked Python 3.12 CI 결과는 이 변경의 공개 브랜치 push 후 별도로 기록한다.
